...
public final class ResourceUtils {
     ...
     * @return the content of assets
     */
    public String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
     ...
     * @return the content of file in assets
     */
    public List<String> readAssets2List(final String assetsPath) {
     ...
     * @return the content of resource in raw
     */
    public String readRaw2String(@RawRes final int resId) {
     ...
     * @return the content of resource in raw
     */
    public  String readRaw2String(@RawRes final int resId, final String charsetName) {
     ...
     * @return the content of file in assets
     */
    public  List<String> readRaw2List(@RawRes final int resId) {
